        ...
        <Link href="/profile">
          <div className={cn(
            ...
            <div className="flex-1 overflow-hidden">
              ...
              <Badge variant="outline" className="text-[9px] h-4 py-0 font-bold uppercase tracking-tight bg-background border-primary/20 text-primary/80">
                {user?.role}
              </Badge>
            </div>
    ...
    <Link href={href}>
      <div className={cn(
        ...
        <div className="flex items-center gap-3">
          <Icon className={cn("w-5 h-5", active ? "text-white" : "text-muted-foreground group-hover:text-primary transition-colors")} />
          {label}
        </div>
